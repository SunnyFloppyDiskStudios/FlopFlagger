...
FlopFlagger was a fun project. I made it because I was initially using the AppleBlox bootstrapper, however it was severly prone to memory leaks and I didn't exactly trust the devs. Also, I was only using it for flagging anyway.
